...
echo "  - The push will trigger a dry-run of the release workflow."
echo "  - Check RELEASE.md on how to do the final run."
echo "  - Check haskell-debugger-view will also be published if needed."
